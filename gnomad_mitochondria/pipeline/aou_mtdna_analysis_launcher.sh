...
#### DOWNLOAD DATA
curl https://personal.broadinstitute.org/rahul/MitochondriaPipelineMongoSwirl_v2.5_Single/scatterWrapper_MitoPipeline_v2_5.wdl -o scatterWrapper_MitoPipeline_v2_5.wdl
curl https://personal.broadinstitute.org/rahul/current_supporting_files/check_variant_bounds.R -o check_variant_bounds.R
curl https://personal.broadinstitute.org/rahul/current_supporting_files/compatibilify_fa_intervals_consensus.R -o compatibilify_fa_intervals_consensus.R
curl https://personal.broadinstitute.org/rahul/current_supporting_files/jsontools.py -o jsontools.py
curl https://personal.broadinstitute.org/rahul/current_supporting_files/merge_per_batch.py -o merge_per_batch.py
curl https://personal.broadinstitute.org/rahul/current_supporting_files/check_overlapping_homoplasmies.R -o check_overlapping_homoplasmies.R
curl https://personal.broadinstitute.org/rahul/current_supporting_files/fix_liftover.py -o fix_liftover.py
curl https://personal.broadinstitute.org/rahul/current_supporting_files/NUMTv3_all385.hg38.interval_list -o NUMTv3_all385.hg38.interval_list
curl https://personal.broadinstitute.org/rahul/current_supporting_files/input_allofus.json -o input_allofus.json
