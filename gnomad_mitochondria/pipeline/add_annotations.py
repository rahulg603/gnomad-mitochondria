...
def process_mt_for_flat_file_analysis(mt, skip_vep, allow_gt_fail):
    ...
    if 'AS_SB_TABLE' in ht.row:
        ht = ht.annotate(FWD_ref = hl.if_else(hl.is_defined(ht.AS_SB_TABLE), hl.int32(ht.AS_SB_TABLE[0].split(',')[0])),
                         FWD_alt = hl.if_else(hl.is_defined(ht.AS_SB_TABLE), hl.int32(ht.AS_SB_TABLE[1].split(',')[0])),
                         REV_ref = hl.if_else(hl.is_defined(ht.AS_SB_TABLE), hl.int32(ht.AS_SB_TABLE[0].split(',')[1])),
                         REV_alt = hl.if_else(hl.is_defined(ht.AS_SB_TABLE), hl.int32(ht.AS_SB_TABLE[1].split(',')[1])))
