...
if __name__ == '__main__':
    ...
    if len(args.specific_chr) == 0:
        ...
        ht = generate_gene_lof_summary(full_mt_per_gene_group)
        ht.export(f'dnax://{my_database}/{args.export_prefix}_worstcsqlof_filtered_pergene_summarystats_allchr{batch_pref_this}.tsv.bgz')
